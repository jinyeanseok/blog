  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="/fishing/listPage">낚시게시판 <span class="sr-only">(current)</span></a></li>
	 ...
	 <br />
	 <br />
	 <h1 align="center"><a href="/fishing/listPage">낚시게시판</a></h1>
	 <div class="container">
			<c:if test="${user != null }">
			<div class="container">
				<a href="/fishing/register"><button class="btn btn-primary btn-xs">새글 작성</button></a>
			</div>
			</c:if>
		</div>
	 <hr />
		...
		<table class="table table-striped">
			...
			<c:forEach items="${list}" var="boardVO">
				<tr>
					...
					<td><a href="/fishing/readView${pageMaker.makeQuery(pageMaker.cri.page)}&board_number=${boardVO.board_number}">${boardVO.title }
			...
			<ul class="pagination">	
				...
				<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var ="idx">
						<li <c:out value="${pageMaker.cri.page == idx ? 'class=active' : '' }"/>>
							<a href="/fishing/listPage${pageMaker.makeQuery(idx)}">
