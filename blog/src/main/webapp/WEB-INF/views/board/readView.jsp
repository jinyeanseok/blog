...
<body>
		...
		<div class="container">
			...
			<button class="btn btn-danger"><a href="/board/delete${cri.makeQuery()}&board_number=${BoardVO.board_number}">삭제</a></button>
			<hr />
			</c:if>
		</div>
		...
		<div class="form-group">
			<div class="container">	
					<div>
						...
						<c:if test="${user.identification == BoardVO.identification }">
							<a href="/board/update${cri.makeQuery()}&board_number=${BoardVO.board_number}" ><button class="btn btn-success">수정</button></a>
						</c:if>
