	...
	<script>
		...
		function createReply() {
			$(".replyWriteBtn").on("click", function() {
				...
				formObj.attr("action", "/coding/replyWrite");
				formObj.submit();
			});
		}
		...
		function updateReply() {
			$(".replyUpdateBtn").on("click", function(){
				location.href = "/coding/replyUpdateView?board_number=${BoardVO.board_number}"
								+ "&page=${cri.page}"
		...
		function deleteReply() {
			$(".replyDeleteBtn").on("click", function(){
				location.href = "/coding/replyDeleteView?board_number=${BoardVO.board_number}"
								+ "&page=${cri.page}"
								+ "&perPageNum=${cri.perPageNum}"
								+ "&reply_number="+$(this).attr("data-reply_number");
			});
...
<body>
		...
		<div class="container">
			...
			<button class="btn btn-danger"><a href="/coding/delete${cri.makeQuery()}&board_number=${BoardVO.board_number}">삭제</a></button>
			<hr />
			</c:if>
		</div>
		...
		<div class="form-group">
			<div class="container">	
					<div>
						<a href="/coding/listPage${cri.makeQuery()}"><button class="btn btn-primary">목록</button></a> 
						
						<c:if test="${user.identification == BoardVO.identification }">
							<a href="/coding/update${cri.makeQuery()}&board_number=${BoardVO.board_number}" ><button class="btn btn-success">수정</button></a>
						</c:if>
						
						<a href="/coding/listPage"><button class="btn btn-info">취소</button></a>
						<br />
					</div>				
			</div>
		</div>
