...
<form method="post" autocomplete="off">
	...
	<h1 class="h2 mb-4 font-weight-normal" id="titleText">Delete User</h1>
	...
	<div>
		<button class="btn btn-lg btn-success btn-block" onclick ="location.href='/board/listPage'">back</button>
	</div>
